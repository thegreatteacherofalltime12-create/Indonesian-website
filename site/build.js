...
const ctx = { site, manifest, catalog };
write('index.html', T.home(ctx));
write('products/index.html', T.catalogPage(ctx));
for (const p of catalog.products) write(`products/${p.sku.toLowerCase()}/index.html`, T.productPage(p, ctx));
write('how-to-order/index.html', T.howToOrder(ctx));
write('workshops/index.html', T.workshops(ctx));
write('contact/index.html', T.contact(ctx));
write('privacy/index.html', T.privacy(ctx));
write('terms/index.html', T.terms(ctx));
