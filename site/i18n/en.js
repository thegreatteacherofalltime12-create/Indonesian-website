...
module.exports = {
  ...
  footer: {
    ...
    legal: (b, basis) => `© ${new Date().getFullYear()} ${b}. Prices quoted ${basis}; the buyer is the importer of record. Export documents are issued with the certified exporter of record.`,
  ...
  terms: {
    ...
    docs: 'Compliance documents', docsP: 'The Seller will arrange commercial invoice, packing list, bill of lading, certificate of origin, V-Legal document where applicable and material/species information, issued with the certified exporter of record. Regulatory compliance in the destination country is the Buyer\'s responsibility.',
