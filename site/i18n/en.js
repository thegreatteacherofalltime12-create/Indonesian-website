...
module.exports = {
  ...
  footer: {
    ...
    legal: (b, basis) => `© ${new Date().getFullYear()} ${b}. Prices quoted ${basis}; the buyer is the importer of record. Export documents are issued in our name as exporter of record.`,
  ...
  home: {
    ...
    services: [
      ...
      ['Inspection before loading', 'We check the container itself before stuffing — shell sound and free of holes, and treated against insects such as cockroaches and ants. Third-party inspection by SGS, QIMA, Intertek or your own agent is welcome.'],
  ...
  how: {
    ...
    steps: base => [
      ...
      '<strong>Samples and production photos.</strong> Samples travel by air, so they are normally paid for in full with the courier cost; on a serious enquiry we will split that cost with you 50/50. Buyer visits to the production facility are welcome — tell us your dates.',
      ...
      '<strong>Inspection.</strong> Before stuffing we check the container shell for holes and have it treated against insects such as cockroaches and ants. Third-party inspection (SGS, QIMA, Intertek) or your own agent is welcome; book it for the week before loading.',
    ...
    claimsH2: 'Claims',
    claimsP: 'Report transit damage with photos promptly after container devanning; we work with you and the carrier on the claim, and manufacturing defects are replaced or credited on the next shipment. Damage must be reported within one week of devanning.',
  ...
  terms: {
    ...
    docs: 'Compliance documents', docsP: 'The Seller will arrange commercial invoice, packing list, bill of lading, certificate of origin, V-Legal document where applicable and material/species information, issued in the Seller’s name as exporter of record. Regulatory compliance in the destination country is the Buyer\'s responsibility.',
